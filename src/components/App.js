    ...
    <div className="App">
        ...
        <Slide appear={false} direction="down" in={!trigger}>
          <AppBar style={appbarStyle}>
            <Toolbar>
              ...
              {isMatch ? (
                <>
                  <Typography style={titleStyle}>CRASH MOB</Typography>
                ...
                <>
                  ...
                  <Tabs
                    ...
                    textColor="inherit"
                    value={navValue}
                    onChange={(event, value) => setNavValue(value)}
      ...
      <Routes>
        <Route
          ...
          path={"/"}
          element={
            <Home fetchUser={checkLogin} loggedInStatus={loggedInStatus} />
          }
        />
        <Route
          ...
          element={
            <>
              <Registration
                fetchUser={checkLogin}
                handleSuccessfulAuth={loggedIn}
              />
            </>
          }
        />
        <Route
          ...
          element={
            <>
              <Login fetchUser={checkLogin} handleSuccessfulAuth={loggedIn} />
            </>
          }
        />
        <Route
          ...
          element={
            <>
              <CharacterIndexParent fetchUser={checkLogin} />
            </>
          }
        />
        <Route
          ...
          element={
            <>
              <NewCharacterParent fetchUser={checkLogin} />
            </>
          }
        />
        <Route
